...
public class NewDirtEvent extends NewRoadEvent{
	 ...
	 * @param type
	 */
	public NewDirtEvent(int time, String id, String idJunctionIni, String idJunctionDest, 
			int maxSpeed, int length, String type) {
	...
	public void execute(RoadMap m) throws SimulatorException {
		try{
			Road r = new Dirt(id, maxSpeed, length, type, m.getJunction(idJunctionIni),
