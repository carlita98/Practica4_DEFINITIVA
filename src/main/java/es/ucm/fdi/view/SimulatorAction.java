...
public class SimulatorAction extends AbstractAction {
	 ...
	 * @param mnemonic
	 *            for menus: a letter that will be underlined. Example:
	 ...
	 */
	public SimulatorAction(Object name, String iconName, String tooltip, Integer mnemonic, String accelerator,
			Runnable callback) {
		super("" + name);
	...
	private static BufferedImage loadImage(String iconName) {
		try {
			InputStream is = SimulatorAction.class.getClassLoader().getResourceAsStream(ICON_BASE + iconName);
